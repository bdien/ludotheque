      ...
      >
        <Toolbar>
          ...
          >
            ...
            <span style={{ color: "hsl(42, 98.3%, 63%)", marginRight: "0.8rem" }}>du</span>
            <span style={{ color: "hsl(158, 51.1%, 65%)", marginRight: "0.5rem" }}>Poisson</span>
          ...
          {!isAuthenticated && (
            <Button sx={{ minWidth: 0 }} color="inherit" onClick={() => loginWithRedirect()}>
